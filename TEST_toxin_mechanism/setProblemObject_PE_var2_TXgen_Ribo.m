function problemObject = setProblemObject_PE_var2_TXgen_Ribo(group_description,output_path,weight,error_model,short_time_course)
    ...
    % var2 assumes that transcription generates the toxin and it acts on
    % ribosomes
    ...
    set(toxin_removal, 'ReactionRate', 'tx_capacity_param');
        ...
        % Add a reaction for Ribosome degradation 
