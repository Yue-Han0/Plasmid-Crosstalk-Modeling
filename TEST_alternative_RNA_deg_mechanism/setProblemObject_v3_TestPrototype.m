function problemObject = setProblemObject_v3_TestPrototype(group_description,group_number,output_path)
    ...
    Mobj = modify_Model_RNAdeg_mechanism(Mobj,'TestPrototype');
