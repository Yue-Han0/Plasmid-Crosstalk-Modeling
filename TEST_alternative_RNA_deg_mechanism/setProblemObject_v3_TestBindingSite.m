function problemObject = setProblemObject_v3_TestBindingSite(group_description,group_number,output_path)
    ...
    Mobj = modify_Model_RNAdeg_mechanism(Mobj,'TestBindingSites');
