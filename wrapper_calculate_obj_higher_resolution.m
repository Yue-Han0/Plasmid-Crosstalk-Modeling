function [scaled_penalty_vec,penalty_term_labels,penalty_term_length,unscaled_penalty_vec] = wrapper_calculate_obj_higher_resolution(estimated_params,problemObject,dosing_information,~,~,mode,num_conc,num_promotor)
    ...
    % % Calculate time-course data using the current set of parameters 
    % simFunction = createSimFunction(model,sampled_param_names,observables,dosing_target_list); 
