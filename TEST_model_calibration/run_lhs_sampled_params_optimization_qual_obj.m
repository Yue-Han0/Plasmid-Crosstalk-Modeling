function run_lhs_sampled_params_optimization_qual_obj(run_idx)
    ...
    save_path_id = sprintf('param_est_run_save/20240822_lhs_sampled_params_opt_run%d.mat',run_idx); 
    wrapper_fit_qualitative_characteristics_w_probObject(problemObject,sampled_params_selected,save_path_id);
